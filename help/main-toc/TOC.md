...
+ 今すぐ始める {#getting-started}
   ...
   + AEMによるプロジェクトの構築 {#project-creation}
...
+ 使用方法 {#using}
   + CI/CD パイプライン {#pipelines}
      ...
      + [ステージと実稼動専用パイプラインの分割](/help/using/stage-prod-only.md)
...
+ コードを管理する {#managing-code}
   ...
   + [外部リポジトリの追加](/help/managing-code/external-repositories.md)
   + [アクセストークンを管理](/help/managing-code/manage-access-tokens.md)
