...
>[!NOTE]
>
>この記事で説明する機能は、早期導入プログラムでのみ利用できます。 詳細および早期導入者として登録する方法については、[ 独自の Git の取り込み ](/help/release-notes/current.md#gitlab-bitbucket) を参照してください。
...
* **GitHub エンタープライズ**
  ...
  ![GitHub エンタープライズでの PR 検証プロセスを示すコミットステータス ](/help/managing-code/assets/repository-webhook-github-pr-validation.png)
