...
description: Adobe Managed ServicesでのCloud Manager 2026.2.0のリリースについて説明します。
...
# Adobe Managed ServicesのCloud Manager 2026.2.0のリリースノート {#release-notes}

<!-- RELEASE WIKI  https://wiki.corp.adobe.com/display/DMSArchitecture/Cloud+Manager+2025.04.0+Release -->

Adobe Managed Servicesの[!UICONTROL Cloud Manager] 2026.2.0のリリースについて説明します。
...
2026.2.0年[!UICONTROL Cloud Manager]のリリース日は2026年2月5日木曜日です。
...
一般リリースの前に今後の機能に早期にアクセスするには、[!UICONTROL Cloud Manager]のベータプログラムに参加してください。

現在、次の機能が利用できます。

### Experience Hub の拡張性とカスタマイズ {#exp-hub-extensibility}

[Experience Hub](https://experienceleague.adobe.com/ja/docs/experience-manager-65/content/experience-hub/experience-hub)は、組織のニーズに合わせてカスタマイズされたAEMの中央アクセス ポイントです。 既存のAEM UI拡張機能に関する詳細をAdobeに提供して、Experience Hubで有効にするのに役立てるようにします。
...
参加するには、[beta_exphubextensibility@adobe.com](mailto:beta_exphubextensibility@adobe.com)にAdobe OrgIDと、作成するカスタマイズの簡単な説明をメールで送信してください。

### モジュールのキャッシュによるビルドの高速化 {#quick-build-cm-pipelines}

新しいビルドモデルでは、モジュールレベルのキャッシュを使用して、変更されたモジュールのみを（リポジトリ全体ではなく）コンパイルし、ビルド時間を短縮します。 これは、コード品質、フルスタック、ステージ専用のパイプラインに適用されます。
...
参加するには、[beta_quickbuild_cmpipelines@adobe.com](mailto:beta_quickbuild_cmpipelines@adobe.com)にAdobeの組織IDとプログラム IDをメールで送信してください。

<!-- You can deactivate incremental builds at the pipeline level by setting the property `CM_BUILD_DISABLE_MODULE_CACHING` to `true` (effective during the `BUILD` step). For how to add pipeline variables, see [Pipeline variables](/help/getting-started/build-environment.md#pipeline-variables). -->

## バグ修正 {#bug-fixes}

AMS版Cloud Managerの2026年2月リリースには、重大なバグ修正はありません。
