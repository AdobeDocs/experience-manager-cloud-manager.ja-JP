...
[Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub)は、組織のニーズに合わせてカスタマイズされたAEMの中央アクセス ポイントです。 既存のAEM UI拡張機能に関する詳細をAdobeに提供して、Experience Hubで有効にするのに役立てるようにします。
