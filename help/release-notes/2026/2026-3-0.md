...
[AEM Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub)のUI拡張機能のサポートが有効になりました。 これにより、開発者は、Adobe App Builderを使用して構築されたカスタム機能とウィジェットでインターフェイスを拡張できます。
