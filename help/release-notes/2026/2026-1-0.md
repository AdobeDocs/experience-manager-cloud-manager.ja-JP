...
[Experience Hub](https://experienceleague.adobe.com/ja/docs/experience-manager-65/content/experience-hub/experience-hub)は、組織のニーズに合わせてカスタマイズされたAEMへのアクセス ポイントです。 既存のAEM UI拡張機能に関する詳細をAdobeに提供することで、Experience Hubで効率的に有効にするのに役立ちます。
