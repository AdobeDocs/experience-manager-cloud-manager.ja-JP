...
一般リリースの前に、今後の機能に限定でアクセスするには、Cloud ManagerのBeta プログラムに参加してください。

現在、次の機能が利用できます。

### Experience Hub の拡張性とカスタマイズ {#exp-hub-extensibility}

[Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub)は、組織のニーズに合わせてカスタマイズされたAEMへのアクセス ポイントです。 既存のAEM UI拡張機能に関する詳細をAdobeに提供することで、Experience Hubで効率的に有効にするのに役立ちます。
...
ベータ版への参加 Adobe OrgID と作成するカスタマイズの簡単な説明を記載して [beta_exphubextensibility@adobe.com](mailto:beta_exphubextensibility@adobe.com) にメールでお問い合わせください。
...
参加しますか？ Adobe OrgID とプログラム ID を記載して [beta_quickbuild_cmpipelines@adobe.com](mailto:beta_quickbuild_cmpipelines@adobe.com) にメールでお問い合わせください。
