...
description: このページでは、Cloud Manager 2019.2.0 について説明します。
...
* Admin Console で新しい「API デベロッパー」の役割が利用可能になりました。これを使用すると、Adobe I/O コンソールで統合を作成する権限を特定のユーザーに付与できます。詳しくは、[ 開発者の管理 ](https://www.adobe.com/go/aac_api_prod_learn_ja) を参照してください。
