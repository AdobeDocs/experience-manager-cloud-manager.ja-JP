...
description: Cloud Manager 2020.5.0のリリースについて詳しく見る
...
# Cloud Manager 2020.5.0のリリースノート {#release-notes-for}

次の節では、[!UICONTROL Cloud Manager] 2020.5.0 のリリースノートの概要を説明します。

## リリース日 {#release-date}

[!UICONTROL Cloud Manager] 2020.5.0 のリリース日は 2020年5月7日（PT）です。
