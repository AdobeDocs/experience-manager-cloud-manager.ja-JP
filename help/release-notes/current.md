...
description: Adobe Managed Services の Cloud Manager 2025.11.0 のリリースについて説明します。
...
# Adobe Managed Services の Cloud Manager 2025.11.0 のリリースノート {#release-notes}

<!-- RELEASE WIKI  https://wiki.corp.adobe.com/display/DMSArchitecture/Cloud+Manager+2025.04.0+Release -->

Adobe Managed Services の [!UICONTROL Cloud Manager] 2025.11.0 のリリースについて説明します。
...
[!UICONTROL Cloud Manager] 2025.11.0 のリリース日は 2025年11月13日（PT）です。
...
Cloud Manager 2025 年 11 月の AMS リリースには、重要な新機能はありません。
...
#### アクセストークンの管理{#manage-access-tokens}
...
AMS リリースの 2025 年 11 月のCloud Managerには、重要なバグ修正はありません。
