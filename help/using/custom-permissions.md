...
Admin Console の使用方法について詳しくは、[エンタープライズユーザーの製品プロファイルの管理](https://helpx.adobe.com/jp/business/enterprise/manage-products-and-entitlements/manage-products-and-product-profiles/manage-product-profiles.html)ドキュメントの&#x200B;**製品プロファイルへのユーザーとユーザーグループの追加**&#x200B;を参照してください。
