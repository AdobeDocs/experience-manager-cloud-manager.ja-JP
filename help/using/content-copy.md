...
* クロスプログラムおよびクロスリージョンのコンテンツコピーはできません。
* クラウドデータストアベースのトポロジのコンテンツコピーは、ソース環境と宛先環境が同じクラウドプロバイダー上にある場合にのみ実行できます。
...
* コンテンツのコピーツールにはバージョン管理機能がなく、前回のコンテンツのコピー操作以降にコンテンツセット内のソース環境で変更されたコンテンツや新しく作成されたコンテンツを自動的に検出できません。
   * 前回のコンテンツのコピー操作以降のコンテンツの変更のみで宛先環境を更新する場合は、コンテンツセットを作成する必要があります。そのセットでは、前回のコンテンツコピー操作以降に変更が加えられたソースインスタンス上のパスを指定します。
* バージョン情報は、コンテンツコピーに含まれていません。
* コンテンツのコピーは、開始後に一時停止したりキャンセルしたりすることはできません。
