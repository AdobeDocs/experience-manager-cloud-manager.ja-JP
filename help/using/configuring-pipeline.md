...
1. **実稼動パイプラインを** 追加ダイアログボックスが表示されます。
   ...
   1. 「**デプロイメントオプション**」を選択します。
      ...
      * **ロードバランサーのスキップ**
   1. 「ステージ」で「**Dispatcher Configurations**」を選択します。 パスを入力し、**型** からアクションを選択して、「**パスを追加**」をクリックします。 1 環境につき最大 100 個のパスを指定できます。
   ...
   1. 実稼動環境用に **Dispatcher 設定** を設定します。 パスを入力し、**型** からアクションを選択して、「**パスを追加**」をクリックします。 1 環境につき最大 100 個のパスを指定できます。
...
1. **実稼動パイプラインを編集** ダイアログボックスが表示されます。
   ...
   1. 「**設定**」タブを使用すると、**パイプライン名**、**リポジトリ**、**Git ブランチ**、**デプロイメントトリガー**、**重要な指標の失敗動作**、**デプロイメントオプション** および **Dispatcher 設定**。
   ...
   1. 「**ステージテスト**」タブには、「**サイトコンテンツ配信/分散読み込みの重み付け**」および「**アセットパフォーマンステストの配布**」からオプションを再選択できます。
