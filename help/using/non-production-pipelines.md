...
* **実稼動パイプライン** – 実稼動パイプラインは、ソースコードを実稼動環境にデプロイするための一連のオーケストレーションされたステップで構成される、専用に構築されたパイプラインです。
...
* **コード品質パイプライン** – これらは、Git ブランチ内のコードに対してコード品質スキャンを実行し、ビルドおよびコード品質ステップを実行します。
...
## 実稼動以外のパイプラインでのスマートビルドの使用{#about-smart-build}
